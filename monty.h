...
void _mod(stack_t **head, unsigned int line_counter);
void _pchar(stack_t **head, unsigned int line_counter);
void _pstr(stack_t **head, unsigned int line_counter);
void _rotl(stack_t **head, unsigned int line_counter);
void _rotr(stack_t **head, __attribute__((unused)) unsigned int line_counter);
void _addnode(stack_t **head, int new_value);
void _addqueue(stack_t **head, int new_value);
void _queue(stack_t **head, unsigned int line_counter);
